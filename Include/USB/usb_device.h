...
void USBEP0SendRAMPtr(BYTE* src, WORD size, BYTE Options);
/*DOM-IGNORE-BEGIN*/
#define USBEP0SendRAMPtr(src,size,options)  {inPipes[0].pSrc.bRam = src;inPipes[0].wCount.Val = size;\
...
void USBEP0SendROMPtr(BYTE* src, WORD size, BYTE Options);
/*DOM-IGNORE-BEGIN*/
#define USBEP0SendROMPtr(src,size,options)  {inPipes[0].pSrc.bRom = src;inPipes[0].wCount.Val = size;\
